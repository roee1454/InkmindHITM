...
For onboarding, sync, status checks, and webhook payloads, see [references/COEXISTENCE.md](references/COEXISTENCE.md).
...
- [Coexistence — Business App + Cloud API on one number](references/COEXISTENCE.md)
